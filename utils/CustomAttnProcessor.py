...
class CustomDiffusionAttnProcessor(nn.Module):
    ...
    def __call__(
        ...
        attention_probs = attn.get_attention_scores(query, key, attention_mask) # (batch_size * head_size, image_sequence_length, text_sequence_length)
        ...
        if attention_probs.shape[-1] == 77:
            ...
            self.controller(attn=attention_probs, is_cross=False, place_in_unet=self.place_in_unet)
